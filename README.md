...
This image is based on the one created by monachus, which you can find [here](https://hub.docker.com/r/monachus/hugo) and that uses the `extended` release of Hugo, which contains support for Sass/SCSS.
